                    ...
                    <div class="params-item__left">
                        <div class="icon">
                            <svg width="39" height="39" viewBox="0 0 39 39">
                                <use xlink:href="<?= $assetsUrl ?>/img/svg/icons.svg#chart"></use>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="params-item__left">
                        <div class="icon">
                            <svg width="33" height="42" viewBox="0 0 33 42">
                                <use xlink:href="<?= $assetsUrl ?>/img/svg/icons.svg#fire"></use>
                            </svg>
                        </div>
                    </div>
                    <div class="params-item__right">
            ...
            <div class="params-item__wrap">
                <div class="params-item__flex">
                    <div class="params-item__left">
                        <div class="icon">
                            <svg width="39" height="39" viewBox="0 0 39 39">
                                <use xlink:href="<?= $assetsUrl ?>/img/svg/icons.svg#glass"></use>
                            </svg>
                        </div>
                    </div>
                    <div class="params-item__right">
